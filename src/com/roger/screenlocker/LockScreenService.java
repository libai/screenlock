...
@SuppressWarnings("deprecation") public class LockScreenService extends Service
    ...
    public void CreateFloatView() {
        ...
        ImageView mCoverDown = (ImageView) findViewById(R.id.cover_down);
        TextView mCoverHint = (TextView) findViewById(R.id.cover_hint);
        Button mClickToClose = (Button) findViewById(R.id.click_to_close);
